...
\begin{itemize}
    ...
    \item El Capítulo 3 detalla la Metodología de desarrollo del proyecto, describiendo la colaboración con el asistente virtual de inteligencia artificial, la estructuración y técnicas de los prompts utilizados, ejemplos prácticos de interacción y las ventajas y desafíos de este paradigma de desarrollo asistido.
    \item El Capítulo 4 expone la Descripción informática del sistema, estructurando sus requisitos funcionales y no funcionales, el análisis de clases y de datos, el diseño arquitectónico bajo los principios de Clean Architecture, los detalles del modelo de la base de datos relacional, la especificación de mecánicas económicas, los núcleos algorítmicos y el plan de verificación y pruebas.
    \item El Capítulo 5 recoge las Conclusiones finales del proyecto, el grado de consecución de los objetivos planteados y las futuras líneas de investigación y trabajo.
\end{itemize}
