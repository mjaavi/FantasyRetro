...
\begin{itemize}
    ...
    \item \textbf{Resolución y Pujas Simuladas de la Máquina}: Se ha verificado la correcta ejecución del motor de cierre de mercado en presencia de jugadores en venta listados por usuarios, comprobando que se generan pujas automáticas del bot en el rango estipulado ([-10\%, +20\%]) y que los traspasos se resuelven de forma segura hacia el mayor postor (ya sea humano o bot), liquidando los saldos y actualizando las plantillas de forma consistente.
\end{itemize}
