...
\input{chapters/descripcionInformatica}
\input{chapters/conclusiones}

% Ficheros de guia de la plantilla (desactivados para la entrega final)
%\input{chapters/componentes} 
%\input{chapters/configuracion}

\appendix

\input{appendices/gdd}
\input{appendices/manual_usuario}

% Archivos de ejemplo de la plantilla
