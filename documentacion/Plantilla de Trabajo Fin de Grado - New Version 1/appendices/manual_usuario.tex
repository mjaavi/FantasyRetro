...
\begin{itemize}
    ...
    \item \textbf{Unirse a una Liga:} Introduzca el código único de invitación (proporcionado por otro mánager administrador).
\end{itemize}
...
\begin{itemize}
    \item \textbf{Poner Transferible:} Un mánager puede ofrecer dinero a otros managers por sus jugadores mientras esta oferta se igual o superior al valorde mercado del jugador.
